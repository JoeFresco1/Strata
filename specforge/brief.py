...
from specforge.models import ProjectBrief
from specforge.project_settings import llm_profiles_by_id
...
class BriefService:
    ...
    def append_plan_turn(self, project_id: str, message: str) -> tuple[str, ProjectBrief, dict[str, Any]]:
        ...
        self.db.append_brief_conversation_turn(project_id=project_id, role="user", content=clean_message)
