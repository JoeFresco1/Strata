...
class Layer2WorkbenchDatabaseMixin:
        ...
        *,
        ...
        self._execute(
            ...
            INSERT INTO layer2_feature_evidence (
                ...
                source_url, evidence_snippet, notes, source_type, created_at, updated_at
            )
    ...
    def get_layer2_competitive_settings(self, project_id: str) -> Layer2CompetitiveSettings:
        ...
        if row is not None:
            return self._row_to_layer2_competitive_settings(row)
        now = utc_now()
        self._execute(
            f"""
            ...
            """,
            (project_id, self._dump_json([]), "known_only", now, now),
        )
    ...
    def _layer2_workbench_row(
        ...
        return {
            **feature,
            ...
            "research_status": "manual_evidence" if feature_evidence else "not_started",
            "competitor_coverage_score": self._feature_competitor_coverage_score(feature_evidence),
