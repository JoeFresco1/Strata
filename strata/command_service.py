...
class CommandService(CommandLifecycleMixin, CommandFreshnessMixin, CommandLayer0Mixin, CommandDiscoveryMixin, CommandLayer1TerritoryMixin, CommandTokenMixin):
