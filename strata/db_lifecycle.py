...
DIRECT_PROJECT_TABLES = [
    ...
    "layer1_territory_runs",
    "layer1_lens_work_items",
    "layer1_lens_attempts",
    "layer1_closed_territory_revisions",
    "layer1_anti_generic_pattern_revisions",
    "layer1_territory_candidates",
    "layer1_normalized_territories",
    "layer1_territory_assessments",
    "layer1_territory_dispositions",
    "layer1_territory_clusters",
    "layer1_lens_coverage_assessments",
    "layer1_adversarial_scenarios",
    "layer1_coverage_states",
