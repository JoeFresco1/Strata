...
export const GUIDE_DECISION_ROUTES = [
  ...
  },
  {
    ...
    go: "Map",
    action: "Start from the map view to see what exists, what is still empty, and where the next review belongs.",
  },
  {
...
export const GUIDE_OPERATIONAL_LAYERS = [
  ...
  },
  {
    ...
    flow: ["Generate or add pillars", "Run overlap critic", "Review", "Establish product areas"],
    description: "This layer defines the major product areas that organize downstream feature work.",
    agentDoes: "Generates candidate pillars, preserves manual additions, and can run the overlap critic to flag same-capability, broader/narrower, fake-novelty, merge, or link pressure.",
    userDoes: "Curates the pillar set, checks overlap warnings, removes weak areas, and approves the major product areas worth exploring further.",
  ...
  },
  {
    ...
    flow: ["Generate features", "Run overlap critic", "Review evidence", "Approve set"],
    description: "This layer turns approved pillars into concrete features with supporting evidence and review decisions.",
    agentDoes: "Generates candidate features, stores evidence and research context, and can run a full-project overlap critic that labels source-specific warning signals without replacing user review.",
    userDoes: "Approves strong features, rejects or revises weak ones, resolves overlap warnings, and decides which features belong in the reviewed product set.",
